...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `41.5µs` | `475.7µs` |
| [Day 2](./src/bin/02.rs) | `51.0µs` | `41.6µs` |
| [Day 3](./src/bin/03.rs) | `319.3µs` | `459.0µs` |
| [Day 4](./src/bin/04.rs) | `76.1µs` | `197.2µs` |
| [Day 5](./src/bin/05.rs) | `22.1µs` | `277.7µs` |
